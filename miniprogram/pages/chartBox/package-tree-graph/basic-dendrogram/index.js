...
Page({
  ...
  onLoad() {
    ...
    this.setData({
      ...
      height: windowHeight,
      pixelRatio,
      downloadBtn:app.globalData.downloadBtn
    });
  },
  ...
  updateChart() {
    ...
    const pluginArr = []
    if (app.globalData.chartViewControl && app.globalData.chartViewControl.miniMap) {
      pluginArr.push(miniMap)
    }
    ...
    this.graph = new F6.TreeGraph({
      ...
      //  plugins: pluginArr,//zoomSlider 缩放轴 只有图类的可以用
    });
