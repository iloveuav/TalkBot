...
exports.walkDomSelector = walkDomSelector;
exports.selectorToArr = selectorToArr;
exports.isSelectorMatchDom = isSelectorMatchDom;
exports.layoutAttrs = exports.reflowAttrs = void 0;
...
function walkDomSelector(dom, fn) {
  if (!dom || !fn) return;
...
function selectorToArr(selector, rex) {
...
function isSelectorMatchDom(dom, selector) {
  if (!dom || !selector) {
    return false;
  }
  ...
  var parts = (0, _tslib.__spreadArray)((0, _tslib.__spreadArray)((0, _tslib.__spreadArray)([], tags || []), ids || []), classes || []);
  var domSels = {};
...
exports.reflowAttrs = reflowAttrs;
var layoutAttrs = {
  left: 1,
  top: 1,
  right: 1,
...
exports.layoutAttrs = layoutAttrs;