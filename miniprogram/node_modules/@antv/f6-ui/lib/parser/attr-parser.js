...
exports.registerAttr = registerAttr;
...
function registerAttr(attr, parser) {
  if (!attr) return;
  var arr = attr;
  ...
  arr.forEach(function (attr) {
    if (typeof parser === 'function') {
      ...
      attributesMap[attr] = _parser.typeParser;
    }
  });
}
...
var borderParser = function borderParser(value) {
  ...
  for (var _i = 0, arr_2 = arr; _i < arr_2.length; _i++) {
    ...
    } else if ((0, _parser.isColor)(value_1)) {
...
var shadowParser = function shadowParser(value) {
  ...
  while (arr.length) {
    ...
    if (!isNaN(Number(value_2))) {
      ...
      continue;
    } else if ((0, _parser.isColor)(value_2)) {
...
function parseAttr(key, value) {
  ...
  try {
    return (0, _parser.typeParser)(value);
  } catch (e) {
    console.error(e);
    return value;
  }
