...
var distance = _f6Core.Util.distance;
var DELTA = 0.05;
...
function (_super) {
  ...
  EdgeFilterLens.prototype.createDelegate = function (e) {
    ...
    if (!lensDelegate || lensDelegate.destroyed) {
      ...
      var pos = graph_1.getPointByClient(e.clientX, e.clientY);
      self.filter(pos);
  ...
  EdgeFilterLens.prototype.scaleRByWheel = function (e, isUp) {
    var self = this;
    if (!e) return;
  ...
  EdgeFilterLens.prototype.filter = function (_a) {
    var x = _a.x,
        y = _a.y;
    var self = this;
    var graph = self.get('graph');
