...
exports.default = createSimpleSlider;

var _f6Ui = require("@antv/f6-ui");

var _const = require("../../utils/const");

function createSimpleSlider(option) {
  var width = option.width,
      _a = option.height,
      height = _a === void 0 ? 4 : _a;
  var handlerStyle = Object.assign({}, _const.SIMPLE_HANDLE_STYLE, option.handlerStyle);
  var backgroundStyle = Object.assign({}, _const.SIMPLE_BACKGROUND_STYLE, option.backgroundStyle);
  var foregroundStyle = Object.assign({}, _const.FOREGROUND_STYLE, option.foregroundStyle);
  var textStyle = Object.assign({}, _const.TEXT_STYLE, option.textStyle);
