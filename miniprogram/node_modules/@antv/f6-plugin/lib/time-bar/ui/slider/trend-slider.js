...
exports.default = createTrendSlider;
exports.AREA_STYLE = exports.TREND_LINE_STYLE = void 0;
...
exports.TREND_LINE_STYLE = TREND_LINE_STYLE;
var AREA_STYLE = {
  fill: '#CACED4',
  opacity: 0.85
};
...
function createTrendSlider(_a) {
  ...
  var width = slider.width,
      _d = slider.height,
      height = _d === void 0 ? _const.TREND_SLIDER_HEIHGT : _d;
  var _e = trend.data,
      trendData = _e === void 0 ? [] : _e,
      lineStyle = trend.lineStyle,
      _f = trend.smooth,
      smooth = _f === void 0 ? true : _f;
  var handlerStyle = Object.assign({}, _const.TREND_HANDLER_STYLE, slider.handlerStyle);
  var backgroundStyle = Object.assign({}, _const.BACKGROUND_STYLE, slider.backgroundStyle);
  var foregroundStyle = Object.assign({}, _const.FOREGROUND_STYLE, slider.foregroundStyle);
  var textStyle = Object.assign({}, _const.TEXT_STYLE, slider.textStyle);
  ...
  var slideContainer = (0, _f6Ui.createSegmentNode)(html, css);
  var path = (0, _path.dataToPath)(trendData, width, height, smooth);
