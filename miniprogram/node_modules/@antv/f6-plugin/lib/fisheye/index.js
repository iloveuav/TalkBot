...
function (_super) {
  ...
  Fisheye.prototype.createDelegate = function (e) {
    ...
    if (!lensDelegate || lensDelegate.destroyed) {
      ...
      var throMmagnify = (0, _util.throttle)(self.magnify.bind(self), 100, {
        leading: false,
        trailing: false
      });
  ...
  Fisheye.prototype.magnify = function (e, mousePos) {
    ...
    if (self.get('dragging') && (self.get('trigger') === 'mousemove' || self.get('trigger') === 'tap')) {
      mCenter = self.get('cacheCenter'); // todo: pc端不需要,why
