...
function (_super) {
  ...
  Tooltip.prototype.showTooltip = function (e) {
    ...
    var html = getHtml((_a = this.get('getContent')) === null || _a === void 0 ? void 0 : _a(e));
    var css = appendCss((_b = this.get('getCss')) === null || _b === void 0 ? void 0 : _b());
    var tooltipUI = createUI(html, css, uiGroup);
